...
export async function run(provider: NetworkProvider, args: string[]) {
    ...
    console.log("[Decrement] Counter value before:", counterBefore);

    await counter.sendDecrement(provider.sender(), {
        value: toNano("0.05"),
    });

    ui.write("Waiting for counter to decrement...");
    ...
    console.log("[Decrement] Counter value after:", counterAfter);
    ui.write("Counter decremented successfully!");
}
