...
interface IEscrow {
    ...
    function withdrawUser(bytes32 secret, IBaseEscrow.Immutables calldata immutables) external;
    function withdrawResolver(bytes32 secret, IBaseEscrow.Immutables calldata immutables) external;
}