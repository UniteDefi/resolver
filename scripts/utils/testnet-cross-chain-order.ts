...
export class TestnetCrossChainOrder {
  ...
  buildExtension(): string {
    ...
    const basePostInteraction = ethers.utils.defaultAbiCoder.encode(
    ...
    const extension = ethers.utils.defaultAbiCoder.encode(
  ...
  build(): any {
    ...
    return {
      ...
      receiver: ethers.constants.AddressZero, // Will receive to maker
